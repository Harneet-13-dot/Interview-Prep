...
const interviewReportModel = require("../model/interview.model")
...
async function generateInterViewReportController(req, res) {
    try {
        ...
        console.log("FROM GEMINI:", JSON.stringify(interViewReportByAi, null, 2))
        ...
        const interviewReport = await interviewReportModel.create({
            ...
            selfDescription,
            jobDescription,
            title: jobDescription?.slice(0, 60) || "Interview Plan",
            ...interViewReportByAi
        })
